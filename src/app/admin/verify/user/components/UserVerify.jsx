...
import { idNumberVerifyApiAction } from '@/actions/userActions';
...
export default function UserVerify() {
  ...
  async function getSearchData(){
      ...
      try{
        const res = await idNumberVerifyApiAction(data?.search);
        if(res?.status == 1) {
          setResult(res)
          setErrMsg({});
          setIsSearch(false);
      ...
      <div className='pb-[4rem]'>
        ...
        <div className='mt-[4rem]'>
          <div className='pb-4 flex items-center justify-between'>
            <p className='text-[1.7rem] font-light'>Verify User:</p>
